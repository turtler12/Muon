...
Muon is intended for only the internal ≥ 2D parameters of a network. Any embedding, classifier, or <2D parameters should be optimized using a different backup optimizer (e.g., AdamW).
